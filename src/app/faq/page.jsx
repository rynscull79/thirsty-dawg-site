...
export default function FAQPage() {
  return (
    <>
      <Head>
        <title>Frequently Asked Questions | Thirsty Dawg Rentals</title>
        <meta
          name="description"
          content="Get answers to common questions about our frozen drink machines, mix options, delivery, setup, alcohol, and more. Everything you need to know before booking!"
        />
      </Head>
