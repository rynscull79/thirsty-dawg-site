...
/>
          ...
          >
            <li style={{ marginBottom: '0.75rem' }}>
              <strong>1.</strong> Choose a Party Pack or build your own — <strong>$150 minimum</strong>
            </li>
            <li style={{ marginBottom: '0.75rem' }}>
              <strong>2.</strong> We deliver your order in a pre-chilled freezer (<strong>$95 rental</strong>)
            </li>
            <li style={{ marginBottom: '0.75rem' }}>
              <strong>3.</strong> Delivery is free in our standard area. Outside areas may incur a fee
            </li>
            <li>
              <strong>4.</strong> We pick it all up after your event — no cleanup, no stress
            </li>
          </ul>
        </div>
      </section>
