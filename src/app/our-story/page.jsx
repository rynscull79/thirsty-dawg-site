...
export default function OurStoryPage() {
  return (
    <>
      <Head>
        <title>Our Story | How Thirsty Dawg Rentals Got Started</title>
        <meta
          name="description"
          content="Meet the team behind Thirsty Dawg Rentals. Learn how our family launched Pensacola’s favorite frozen drink rental service — plus meet our Boston Terrier mascots!"
        />
      </Head>
